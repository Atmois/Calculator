...
double arithmetic(double num1, double num2, std::string calcOperator) {
  if (calcOperator == "+") {
    return num1 + num2;
...
std::string getOperator(char calcMode, std::string calcOperator) {
  if (calcMode == 'a') {
...
char continueCheck(std::string calcProcess, char continueProgram) {
